                        ...
                        <div className="mb-10">
                            ...
                            <div className="prose prose-lg text-samawah-grey/80 max-w-none leading-relaxed">
                                <p className="mb-4 font-medium text-samawah-navy text-xl">
                                    "المحتوى الكوميدي ليس مجرد نكتة، هو مرآة تعكس هموم المجتمع بذكاء."
                                </p>
                                <p className="mb-4">
                                    نناقش في هذا اللقاء كيف تحولت الكوميديا في الخليج من المسرح التقليدي إلى المنصات الرقمية، وكيف يمكن لصناع المحتوى الحفاظ على التوازن بين الجرأة والقبول المجتمعي، مع استشراف مستقبل هذا القطاع في ظل الانفتاح الثقافي الكبير.
                                </p>
                            </div>
                        </div>
