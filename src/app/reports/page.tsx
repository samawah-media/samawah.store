...
const reportsData = [
    {
        ...
        description: 'أول تقرير استراتيجي ينقلك من مطاردة الأرقام اللحظية إلى بناء إدارة إعلامية واعية.\nبدل الإنفاق على حملات عابرة، ابدأ تأسيس أصول إعلامية مستدامة تبقى معك لسنوات.',
